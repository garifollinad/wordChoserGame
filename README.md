...
- It has dynamic feature for adding new words to search list once to click on "+" plusButton.
- Once user finds the word, it gets striked out.
...
P.S. Screenshots of three states(no/some/all words found) are attached to repository
